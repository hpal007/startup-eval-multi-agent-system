...
def assess_data_recency(source_date: str, current_date: Optional[str] = None) -> Dict[str, any]:
    """
...
def identify_discrepancy_flags(
    tam_variance: Optional[float] = None,
    sam_variance: Optional[float] = None,
    som_variance: Optional[float] = None,
...
def _parse_market_size(size_str: str) -> Optional[float]:
...
def validate_tam_sam_som_logic(tam: Optional[float], sam: Optional[float], som: Optional[float]) -> Dict[str, any]:
    """
