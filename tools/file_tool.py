...
class UploadArtifactTool():
    ...
    """
    async def run(self, callback_context, file_path: str = None, file_bytes: bytes = None, filename: str = "tool_uploaded.pdf") -> dict:
        try:
            if not file_path and not file_bytes:
                return {"status": "error", "message": "Either file_path or file_bytes must be provided."}
